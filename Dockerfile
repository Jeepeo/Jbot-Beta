...
RUN apk add --no-cache python3 \
    py-pillow py-requests py-sqlalchemy py-psycopg2 py-lxml libxslt-dev py-pip libxml2 libxml2-dev libpq postgresql-dev postgresql build-base python-dev python3-dev \
